                ...
                stage('Secret Scanning'){
                       steps{
                            script{
                                ...
                                sh 'docker run --rm -i -v "$PWD:/repo" trufflesecurity/trufflehog:latest git file://. --no-update --entropy --regex --concurrency=2 --include-detectors="all" --json-legacy >> trufflehog_output.json'
